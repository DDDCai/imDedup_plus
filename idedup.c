...
//  * @LastEditTime: 2022-05-13 09:01:01
//  * @Description: 
//  */
// #include "idedup.h"
// #include "2df.h"
...
//         }
//         // GHashTable      **featureT[MIDDLE_THREAD_NUM];
//         // pthread_mutex_t *ftMutex[MIDDLE_THREAD_NUM];
//         // for(int i=0; i<MIDDLE_THREAD_NUM; i++)
//         // {
//         //     featureT[i] =   (GHashTable**)malloc(sizeof(GHashTable*)*SF_NUM);
//         //     ftMutex[i]  =   (pthread_mutex_t*)malloc(sizeof(pthread_mutex_t)*SF_NUM);
//         //     for(int j=0; j<SF_NUM; j++)
//         //     {
//         //         featureT[i][j]  =   g_hash_table_new_full(g_int64_hash,g_int64_equal,NULL,free_ht_val);
//         //         pthread_mutex_init(&ftMutex[i][j],NULL);
//         //     }
//         // }
...
//         //     for(int j=0; j<SF_NUM; j++)
//         //     {
//         //         g_hash_table_destroy(featureT[i][j]);
//         //         pthread_mutex_destroy(&ftMutex[i][j]);
//         //     }
//         //     free(featureT[i]);
//         //     free(ftMutex[i]);
//         // }
 ...
 * @Date: 2020-11-09 14:24:32
 * @LastEditors: Cai Deng
 * @LastEditTime: 2022-05-15 13:50:00
 * @Description: 
 */
#include "idedup.h"
#include "2df.h"
